...
add_action( 'tgmpa_register', 'copallyt_register_required_plugins' );
 ...
 */
function copallyt_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'      => esc_html__( 'WPBakery Visual Composer','copallyt' ), // The plugin name
		...
		array(
			'name'      => esc_html__('Slider Revolution' ,'copallyt' ),
			'slug'      => 'revslider',
		...
		array(
			'name'      => esc_html__('wd main plugin' ,'copallyt' ), // The plugin name
