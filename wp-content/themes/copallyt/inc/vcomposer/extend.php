...
$vc_add_css_animation = array(
	'type' => 'dropdown',
	'heading' => esc_html__( 'CSS Animation', 'copallyt' ),
	'param_name' => 'css_animation',
	'admin_label' => true,
	'value' => array(
		  esc_html__( 'No', 'copallyt' ) => '',
		  esc_html__('Bounce In', 'copallyt' ) => 'bounceIn',
          esc_html__('Bounce In Down', 'copallyt' ) => 'bounceInDown',
          esc_html__('Bounce In Left', 'copallyt' ) => 'bounceInLeft',
          esc_html__('Bounce In Right', 'copallyt' ) => 'bounceInRight',
          esc_html__('Bounce In Up', 'copallyt' ) => 'bounceInUp',
          esc_html__('Fade In', 'copallyt' ) => 'fadeIn',
          esc_html__('Fade In Down', 'copallyt' ) => 'fadeInDown',
          esc_html__('Fade In Down Big', 'copallyt' ) => 'fadeInDownBig',
          esc_html__('Fade In Left', 'copallyt' ) => 'fadeInLeft',
          esc_html__('Fade In Left Big', 'copallyt' ) => 'fadeInLeftBig',
          esc_html__('Fade In Right', 'copallyt' ) => 'fadeInRight',
          esc_html__('Fade In Right Big', 'copallyt' ) => 'fadeInRightBig',
          esc_html__('Fade In Up', 'copallyt' ) => 'fadeInUp',
          esc_html__('Fade In Up Big', 'copallyt' ) => 'fadeInUpBig',
          esc_html__('Flip', 'copallyt' ) => 'flip',
          esc_html__('Flip In X', 'copallyt' ) => 'flipInX',
          esc_html__('Flip In Y', 'copallyt' ) => 'flipInY',
          esc_html__('Flip Out X', 'copallyt' ) => 'flipOutX',
          esc_html__('Flip Out Y', 'copallyt' ) => 'flipOutY',
          esc_html__('Light Speed In', 'copallyt' ) => 'lightSpeedIn',
          esc_html__('Light Speed Out', 'copallyt' ) => 'lightSpeedOut',
          esc_html__('Rotate In', 'copallyt' ) => 'rotateIn',
          esc_html__('Rotate In Down Left', 'copallyt' ) => 'rotateInDownLeft',
          esc_html__('Rotate In Down Right', 'copallyt' ) => 'rotateInDownRight',
          esc_html__('Rotate In Up Left', 'copallyt' ) => 'rotateInUpLeft',
          esc_html__('Rotate In Up Right', 'copallyt' ) => 'rotateInUpRight',
          esc_html__('Slide In Up', 'copallyt' ) => 'slideInUp',
          esc_html__('Slide In Down', 'copallyt' ) => 'slideInDown',
          esc_html__('Slide In Left', 'copallyt' ) => 'slideInLeft',
          esc_html__('Slide In Right', 'copallyt' ) => 'slideInRight',
          esc_html__('Zoom In ', 'copallyt' ) => 'zoomIn',
          esc_html__('Zoom In Down', 'copallyt' ) => 'zoomInDown',
          esc_html__('Zoom In Left', 'copallyt' ) => 'zoomInLeft',
          esc_html__('Zoom In Right', 'copallyt' ) => 'zoomInRight',
          esc_html__('Zoom In Up', 'copallyt' ) => 'zoomInUp',
          esc_html__('Roll In', 'copallyt' ) => 'rollIn',
	),
	'description' => esc_html__( 'Select type of animation for element to be animated when it "enters" the browsers viewport (Note: works only in modern browsers).', 'copallyt' )
);
...
vc_map( array(
	"name" => esc_html__("Text Block with Icon", 'copallyt'),
	"base" => "wd_icon_text",
	...
	"params" => array(
		...
		array(
			"type" => "checkbox",
			"heading" => esc_html__("Display border", 'copallyt'),
			"param_name" => "text_icon_border_checkbox",
			'value' => array( esc_html__( 'Yes, please', 'copallyt' ) => 'yes' ),
		),
		array(
			"type" => "textfield", // it will bind a textfield in WP
