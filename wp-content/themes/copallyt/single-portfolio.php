					...
					<article id="node-4" class="node node-project node-promoted view-mode-full">
						...
						<div class="large-7 columns">
							<div id="flexslider-1" class="flexslider flexslider-processed">
								<?php the_post_thumbnail('copallyt_650x350'); ?>
							</div>
						</div>
						<div class="large-5 columns">
							<div class="project-tete clearfix">
								<h5 class="block-title project-description"><?php echo esc_html__( 'Project Description', 'copallyt' ) ?></h5>
							...
							<div class="project-tete clearfix">
								<h5 class="block-title project-description"><?php echo esc_html__( 'Project Type', 'copallyt' ) ?></h5>
								<span class="line"></span>
							</div>
